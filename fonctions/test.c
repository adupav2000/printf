...
/*   Updated: 2020/02/16 10:15:11 by adu-pavi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
  int a;
  a = 0;
  printf("___printf = -011d = %-011d\n", 412);
  printf("___printf = -011d = %-011d\n", -412);
  printf("___printf = -5.2d = %-5.2d\n", 412);
  printf("___printf = -5.2d = %-5.2d\n", -412);
  printf("___printf = -01d = %-01d\n", 412);
  printf("___printf = -1d = %-01d\n", -412);
  printf("___printf = 22.-11d = %22.-11d\n", 412);
  printf("___printf = 22.-11d = %22.-11d\n", -412);
  printf("___printf = -2.11d = %-2.11d\n", 412);
  printf("___printf = -2.11d = %-2.11d\n", -412);
  printf("___printf = -22.11d = %-22.11d\n", 412);
  printf("___printf = -22.11d = %-22.11d\n", -412);
  printf("___printf = 2.-11d = %2.-11d\n", 412);
  printf("___printf = 2.-11d = %2.-11d\n", -412);
  printf("___printf = 2.-1d = %2.-1d\n", 412);
  printf("___printf = 2.-1d = %2.-1d\n", -412);
  printf("___printf = -2.-11d = %-2.-11d\n", 412);
  printf("___printf = -2.-11d = %-2.-11d\n", -412);
  printf("___printf = -22.-1d = %-22.-1d\n", 412);
  printf("___printf = -22.-1d = %-22.-1d\n", -412);
  printf("___printf = -22.-11d = %-22.-11d\n", 412);
  printf("___printf = -22.-11d = %-22.-11d\n", -412);
